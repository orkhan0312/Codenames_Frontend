...
const Createroom = () => {
    return(
        <div>
            ...
            <form className={"crroom"}>
                <label>Language of the words:</label>
                <div className="flex flex-col items-center py-16 bg-gray-100">
                    <ul  id="filter1" className="filter-switch inline-flex items-center relative h-10 p-1 space-x-1 bg-gray-200 rounded-md font-semibold text-blue-600 my-4">
                        ...
                        <li className="filter-switch-item flex relative h-8 bg-gray-300x">
                            <input type={"radio"} name={"filter1"} id={"filter1-1"} className="sr-only" checked/>
                        ...
                        <li className="filter-switch-item flex relative h-8 bg-gray-300x">
                            <input type={"radio"} name={"filter1"} id={"filter1-2"} className="sr-only" checked/>
                        ...
                        <li className="filter-switch-item flex relative h-8 bg-gray-300x">
                            <input type={"radio"} name={"filter1"} id={"filter1-3"} className="sr-only" checked/>
